...
- ⚠️ Full on-device AR testing (live image tracking, tap detection against a real camera feed) was not achievable during development due to the device compatibility issue described in Limitations — testing was limited to Editor/XR Simulation and a successful build/install pass
